...
import { getServerSession } from 'next-auth'; // Import next-auth's getServerSession
import { authOptions } from '@/lib/auth'; // Adjust the import path to your NextAuth options
